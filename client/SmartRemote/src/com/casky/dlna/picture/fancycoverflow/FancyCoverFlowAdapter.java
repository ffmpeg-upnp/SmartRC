...
package com.casky.dlna.picture.fancycoverflow;
...
public abstract class FancyCoverFlowAdapter extends BaseAdapter {
    ...
    public final View getView(int i, View reusableView, ViewGroup viewGroup) {
        ...
        FancyCoverFlow.LayoutParams params = 
        		new FancyCoverFlow.LayoutParams(300, 300);
        coverFlowItem.setLayoutParams(params);
