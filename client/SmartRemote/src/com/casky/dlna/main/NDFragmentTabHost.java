 ...
 */
public class NDFragmentTabHost extends TabHost implements
    ...
    public NDFragmentTabHost(Context context) {
    ...
    public NDFragmentTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
